...
class KflodSplitter(Splitter):
    ...
    def split(self, dataset: DataSet) -> Tuple[DataSet, DataSet]:
        df = pd.read_table(r'C:\Users\Lenovo\Desktop\dlframe-back-master\tests\iris.txt', sep=",", header=None, encoding=None)
        X = df[[0, 1, 2, 3]]
        Y = df[[4]]
        x_train, x_test, y_train, y_test = K_Flod_spilt(10, 1, X, Y)
        train_x = py.array(x_train)
        train_y = py.array(y_train)
        test_x = py.array(x_test)
        test_y = py.array(y_test)
...
class KNN_2(Model):
    ...
    def test(self, testdata: DataSet) -> Any:
        ...
        plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\test_iris_KNN'+str(PH)+'.png')
        PH+=1
...
class GBM(Model):
    ...
    def test(self, testdata: DataSet) -> Any:
        ...
        plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\鸢尾花-测试集GBM'+str(PH)+'.png')
...
class Logistic(Model):
     ...
     def test(self, testDataset: DataSet) -> Any:       
         ...
         test_result = self.clf.predict(testDataset.X)   
         ...
         plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\logistic'+str(PH)+'.png')
         ...
         # 利用热力图对于混淆矩阵进行可视化
         ticks = py.unique(train_y)
         plt.figure(figsize=(8, 6))
         sns.heatmap(confusion_matrix_result, xticklabels=ticks, yticklabels=ticks, annot=True, cmap='YlGnBu')
         plt.xlabel('Predicted labels')
         plt.ylabel('True labels')
         # plt.show()
         plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\logistic-混淆矩阵'+str(PH)+'.png')
...
class Decision_Tree(Model):
     ...
     def test(self, testdata: DataSet) -> Any:
         ...
         plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\DecisionTree'+str(PH)+'.png')
         return test_predict
...
class NavieBayes(Model):
    ...
    def test(self, testdata: DataSet) -> Any:
        ...
        plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\鸢尾花-测试集NB'+str(PH)+'.png')
...
class SVM(Model):
    ...
    def test(self, testdata: DataSet) -> Any:
        ...
        plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\test_iris_SVM'+str(PH)+'.png')
...
class SVR(Model):
    ...
    def test(self, testdata: DataSet) -> Any:
        ...
        plt.title('波士顿房价-测试集')
        plt.legend()
        plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\波士顿房价-测试集SVR'+str(PH)+'.png')
...
class XGBoost_C(Model):
    ...
    def test(self, testdata: DataSet) -> Any:
        ...
        plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\鸢尾花-测试集XGB'+str(PH)+'.png')
...
class XGBoost_R(Model):
    ...
    def test(self, testdata: DataSet) -> Any:
        ...
        plt.title('波士顿房价-测试集')
        plt.legend()
        plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\波士顿房价-测试集XGB'+str(PH)+'.png')
        plot_importance(self.model)
        plt.savefig(r'C:\Users\Lenovo\Desktop\dlframe-back-master\images\波士顿房价XGB重要特征'+str(PH)+'.png')
