...
def main():
    # Read in image
    im = Image.open(r'C:\Users\Spark\Desktop\1.jpeg')
    im = np.array(im)
    ...
    cv2.imwrite(r'D:\VSProject\image\lev-16.png', lev * 20)

    # Get the color average based on locav
    out = ACAreconstruction(lev, locav)
    cv2.imwrite(r'D:\VSProject\image\locav-16.png', out)
